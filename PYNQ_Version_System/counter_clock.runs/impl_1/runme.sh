...
HD_PWD='C:/Users/andre/OneDrive/Desktop/Sistema/counter_clock.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_Transfer_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source UART_Transfer_wrapper.tcl -notrace
