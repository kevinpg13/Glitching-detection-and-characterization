...
HD_PWD='C:/Users/andre/OneDrive/Desktop/Sistema/counter_clock.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_Transfer_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UART_Transfer_wrapper.tcl
