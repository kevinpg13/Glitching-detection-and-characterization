...
#
# Script generated by Vivado on Thu Oct 09 15:12:44 -0400 2025
...
# script info
echo -e "ila_0.sh - Script generated by export_simulation (Vivado v2024.1.2 (64-bit)-id)\n"
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../counter_clock.gen/sources_1/ip/ila_0/hdl/verilog" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../counter_clock.gen/sources_1/ip/ila_0/hdl/verilog" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
