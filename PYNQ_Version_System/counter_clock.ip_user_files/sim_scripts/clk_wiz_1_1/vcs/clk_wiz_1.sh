...
#
# Script generated by Vivado on Tue Sep 16 13:02:00 -0400 2025
...
# script info
echo -e "clk_wiz_1.sh - Script generated by export_simulation (Vivado v2024.1.2 (64-bit)-id)\n"
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../ipstatic" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../ipstatic" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../ipstatic" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
