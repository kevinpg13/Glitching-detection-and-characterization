...
# set xvlog options
xvlog_opts="--incr --relax  -L axi_vip_v1_1_18 -L processing_system7_vip_v1_0_20 -L xilinx_vip"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot clk_wiz_1 xil_defaultlib.clk_wiz_1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim clk_wiz_1 -key {Behavioral:sim_1:Functional:clk_wiz_1} -tclbatch cmd.tcl -protoinst "protoinst_files/UART_Transfer.protoinst" -log simulate.log
}
