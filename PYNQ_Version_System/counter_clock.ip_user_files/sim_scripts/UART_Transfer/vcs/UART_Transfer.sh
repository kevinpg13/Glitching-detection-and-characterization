...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../counter_clock.gen/sources_1/bd/UART_Transfer/ipshared/ec67/hdl" +incdir+"../../../../counter_clock.gen/sources_1/bd/UART_Transfer/ipshared/d47c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../counter_clock.gen/sources_1/bd/UART_Transfer/ipshared/ec67/hdl" +incdir+"../../../../counter_clock.gen/sources_1/bd/UART_Transfer/ipshared/d47c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../../counter_clock.gen/sources_1/bd/UART_Transfer/ipshared/ec67/hdl" +incdir+"../../../../counter_clock.gen/sources_1/bd/UART_Transfer/ipshared/d47c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../counter_clock.gen/sources_1/bd/UART_Transfer/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_vip_v1_1_18 $vlogan_opts -sverilog +incdir+"../../../../counter_clock.gen/sources_1/bd/UART_Transfer/ipshared/ec67/hdl" +incdir+"../../../../counter_clock.gen/sources_1/bd/UART_Transfer/ipshared/d47c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../counter_clock.gen/sources_1/bd/UART_Transfer/ipshared/1f8d/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work processing_system7_vip_v1_0_20 $vlogan_opts -sverilog +incdir+"../../../../counter_clock.gen/sources_1/bd/UART_Transfer/ipshared/ec67/hdl" +incdir+"../../../../counter_clock.gen/sources_1/bd/UART_Transfer/ipshared/d47c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../counter_clock.gen/sources_1/bd/UART_Transfer/ipshared/d47c/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../counter_clock.gen/sources_1/bd/UART_Transfer/ipshared/ec67/hdl" +incdir+"../../../../counter_clock.gen/sources_1/bd/UART_Transfer/ipshared/d47c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work generic_baseblocks_v2_1_2 $vlogan_opts +v2k +incdir+"../../../../counter_clock.gen/sources_1/bd/UART_Transfer/ipshared/ec67/hdl" +incdir+"../../../../counter_clock.gen/sources_1/bd/UART_Transfer/ipshared/d47c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../counter_clock.gen/sources_1/bd/UART_Transfer/ipshared/0c28/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work fifo_generator_v13_2_10 $vlogan_opts +v2k +incdir+"../../../../counter_clock.gen/sources_1/bd/UART_Transfer/ipshared/ec67/hdl" +incdir+"../../../../counter_clock.gen/sources_1/bd/UART_Transfer/ipshared/d47c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work axi_data_fifo_v2_1_31 $vlogan_opts +v2k +incdir+"../../../../counter_clock.gen/sources_1/bd/UART_Transfer/ipshared/ec67/hdl" +incdir+"../../../../counter_clock.gen/sources_1/bd/UART_Transfer/ipshared/d47c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../counter_clock.gen/sources_1/bd/UART_Transfer/ipshared/2ccb/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_register_slice_v2_1_32 $vlogan_opts +v2k +incdir+"../../../../counter_clock.gen/sources_1/bd/UART_Transfer/ipshared/ec67/hdl" +incdir+"../../../../counter_clock.gen/sources_1/bd/UART_Transfer/ipshared/d47c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../counter_clock.gen/sources_1/bd/UART_Transfer/ipshared/676c/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_protocol_converter_v2_1_32 $vlogan_opts +v2k +incdir+"../../../../counter_clock.gen/sources_1/bd/UART_Transfer/ipshared/ec67/hdl" +incdir+"../../../../counter_clock.gen/sources_1/bd/UART_Transfer/ipshared/d47c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.UART_Transfer xil_defaultlib.glbl -o UART_Transfer_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./UART_Transfer_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key UART_Transfer_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc UART_Transfer_simv.daidir vcs_lib c.obj)
