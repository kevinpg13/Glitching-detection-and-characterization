...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../counter_clock.gen/sources_1/ip/ila_0_1/hdl/verilog" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../counter_clock.gen/sources_1/ip/ila_0_1/hdl/verilog" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
